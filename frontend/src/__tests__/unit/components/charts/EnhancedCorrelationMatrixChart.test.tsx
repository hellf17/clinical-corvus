...
describe('EnhancedCorrelationMatrixChart', () => {
  ...
  it('allows selecting different parameters', async () => {
    ...
    // Chart should render correlation matrix for selected parameters
    expect(screen.getByTestId('correlation-matrix-table')).toBeInTheDocument();
  });
  ...
  it('shows a message when no exams are available', () => {
    render(<EnhancedCorrelationMatrixChart exams={[]} />);
    
    expect(screen.getByText('Não há dados suficientes para gerar uma matriz de correlação.')).toBeInTheDocument();
    expect(screen.queryByTestId('correlation-matrix-table')).not.toBeInTheDocument();
  });
  
  it('renders with custom title', () => {
    const customTitle = 'Matriz de Correlação Personalizada';
    render(<EnhancedCorrelationMatrixChart exams={mockExams} title={customTitle} />);
  ...
  it('handles loading state', () => {
    render(<EnhancedCorrelationMatrixChart exams={mockExams} loading={true} />);
  ...
  it('handles error state', () => {
    render(<EnhancedCorrelationMatrixChart exams={mockExams} error="Erro ao carregar dados" />);
