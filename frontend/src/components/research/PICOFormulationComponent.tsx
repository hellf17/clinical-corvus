...
interface PICOFormulationOutput {
  ...
  formulation_explanation: string;
...
const picoExamples = [
  {
    ...
    scenario: "Paciente de 65 anos com hipertensão arterial sistêmica de difícil controle, usando atualmente losartana 100mg e hidroclorotiazida 25mg, com pressão arterial mantendo-se em 160/95 mmHg. Médico considera adicionar amlodipina.",
    pico: {
      P: "Pacientes idosos com hipertensão não controlada",
      I: "Adição de amlodipina ao esquema atual",
      C: "Manutenção do esquema atual sem amlodipina",
...
export default function PICOFormulationComponent({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/deep-research/formulate-pico', {
        method: 'POST',
        headers: {
        ...
        <CardContent className="space-y-6">
          ...
          {results && (
            <div className="mt-8 space-y-6">
              ...
              {/* Componentes PICO Detalhados */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                  <div className="flex items-center mb-2">
                    <Badge className="mr-2 bg-purple-600">P</Badge>
                    <h4 className="font-semibold text-purple-800">População</h4>
                  </div>
                  <p className="text-sm text-purple-700">{results.pico_components.population}</p>
                </div>
                
                <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                  <div className="flex items-center mb-2">
                    <Badge className="mr-2 bg-purple-600">I</Badge>
                    <h4 className="font-semibold text-purple-800">Intervenção</h4>
                  </div>
                  <p className="text-sm text-purple-700">{results.pico_components.intervention}</p>
                </div>
                
                <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                  <div className="flex items-center mb-2">
                    <Badge className="mr-2 bg-purple-600">C</Badge>
                    <h4 className="font-semibold text-purple-800">Comparação</h4>
                  </div>
                  <p className="text-sm text-purple-700">{results.pico_components.comparison}</p>
                </div>
                
                <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                  <div className="flex items-center mb-2">
                    <Badge className="mr-2 bg-purple-600">O</Badge>
                    <h4 className="font-semibold text-purple-800">Outcome (Desfecho)</h4>
                  </div>
                  <p className="text-sm text-purple-700">{results.pico_components.outcome}</p>
                </div>
              </div>
              ...
              <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="font-semibold text-purple-800">Raciocínio Detalhado (Chain-of-Thought)</h4>
                </div>
                <p className="text-sm text-purple-700 leading-relaxed">{results.detailed_reasoning}</p>
              </div>
              ...
              <div className="p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="font-semibold text-indigo-800">Explicação da Formulação</h4>
                </div>
                <p className="text-sm text-indigo-700 leading-relaxed">{results.formulation_explanation}</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                  <div className="flex items-center mb-3">
                    ...
                    <h4 className="font-semibold text-gray-800">Termos de Busca Sugeridos</h4>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {results.search_terms_suggestions.map((term, index) => (
                      <Badge 
                        key={index} 
                        variant="outline" 
                ...
                <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                  <div className="flex items-center mb-3">
                    ...
                    <h4 className="font-semibold text-gray-800">Tipos de Estudo Recomendados</h4>
                  </div>
              ...
              {results.boolean_search_strategies.length > 0 && (
                <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                  <div className="flex items-center mb-3">
                    ...
                    <h4 className="font-semibold text-purple-800">Estratégias de Busca Booleana</h4>
                  </div>
              ...
              {results.alternative_formulations.length > 0 && (
                  ...
                  <CollapsibleTrigger asChild>
                    ...
                    >
                      <span className="flex items-center">
                        ...
                        Formulações Alternativas ({results.alternative_formulations.length})
                      </span>
                      {alternativesExpanded ? <ChevronUp className="h-4 w-4" /> : <ChevronDown className="h-4 w-4" />}
                    </Button>
                  </CollapsibleTrigger>
                  <CollapsibleContent className="space-y-3 mt-4">
                    {results.alternative_formulations.map((alternative, index) => (
              ...
              <div className="p-4 bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-semibold text-indigo-800 mb-1">Pronto para buscar evidências?</h4>
