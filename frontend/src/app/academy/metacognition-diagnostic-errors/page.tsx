...
import BiasLibraryComponent from '@/components/metacognition/BiasLibraryComponent';
import CaseBiasAnalysisComponent from '@/components/metacognition/CaseBiasAnalysisComponent';
import SelfReflectionComponent from '@/components/metacognition/SelfReflectionComponent';
import DiagnosticTimeoutComponent from '@/components/metacognition/DiagnosticTimeoutComponent';
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="diagnostic-timeout">
          <DiagnosticTimeoutComponent 
            ...
            onTimeoutCompleted={(insights: { alternatives: string[]; overlooked: string[]; redFlags: string[] }) => {
              setCrossComponentState(prev => ({ 
                ...prev, 
                timeoutRecommendations: {
                  timeout_recommendation: "Análise de timeout concluída",
                  alternative_diagnoses_to_consider: insights.alternatives,
                  key_questions_to_ask: [],
                  red_flags_to_check: insights.redFlags,
                  next_steps_suggested: [],
                  cognitive_checks: [],
                  disclaimer: "Análise educacional para fins de treinamento."
                }
              }));
            }}
          />
