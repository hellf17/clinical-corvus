...
export default function AnalysisPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const apiUrl = `${getAPIUrl()}/api/lab-analysis/manual-guest`;
  ...
  const handleCopyAllResults = () => {
    try {
      ...
      if (drCorvusInsights) {
        ...
        if (drCorvusInsights.general_disclaimer) {
          copyText += `\nDisclaimer: ${drCorvusInsights.general_disclaimer}\n`;
        }
      }
  ...
  const handleGenerateDrCorvusInsights = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/dr-corvus/insights', {
        method: 'POST',
        headers: {
          ...
          <div className="p-6 md:p-10">
            ...
            {drCorvusInsights && !isGeneratingInsights && (
              <div ref={insightsContainerRef} className="mt-8 p-6 border-2 border-blue-900 rounded-lg shadow-xl">
                ...
                {/* Disclaimer */}
                {drCorvusInsights.general_disclaimer && (
