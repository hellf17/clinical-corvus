...
export async function POST(request: NextRequest) {
  try {
    ...
    const targetUrl = `${BACKEND_API_URL}/api/research/appraise-evidence`; 

    console.log(`Forwarding POST request from /api/research/appraise-evidence to ${targetUrl}`);
    ...
    console.error('Error in Next.js API route /api/research-assistant/appraise-evidence:', error);
