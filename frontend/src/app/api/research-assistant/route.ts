...
export async function POST(request: NextRequest) {
  try {
    ...
    const targetUrl = `${BACKEND_API_URL}/api/deep-research`; 

    console.log(`Forwarding POST request from /api/deep-research to ${targetUrl}`);
    ...
    console.error('Error in Next.js API route /api/deep-research:', error);
