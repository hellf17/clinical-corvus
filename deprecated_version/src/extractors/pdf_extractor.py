...
def extrair_campos_do_texto(texto):
    ...
    for key in dados_extraidos:
        if key not in ['Proteinuria', 'Cetonuria', 'Nitrito', 'Leveduras', 'Bacteriuria', 
                      ...
                      'Hemocult', 'HemocultAntibiograma', 'Urocult', 'CoombsDir', 
                      'GrupoABO', 'FatorRh', 'BetaHCG', 'HBsAg', 'AntiHBs', 'AntiHBcTotal',
                      'AntiHVAIgM', 'HCV', 'HIV', 'VDRL', 'DengueNS1', 'CultVigilNasal', 'CultVigilRetal']:
            try:
