...
*   **Complete Translation to Portuguese:** All APIs and educational features of the Clinical Academy are 100% translated, ensuring a native and accessible learning experience.
...
|-------|-----------|------------|
| 1 | **Query Pre-processing (`simple_autonomous_research.py`)** | • Expansion of medical abbreviations in PT.<br>• Automatic translation to EN (DeepL → BAML).<br>• Synonym expansion.<br>• Generation/simplification via BAML (PICO / keywords). |
